...
export default function ReferenceImportPage() {
  ...
  return (
    <div className="max-w-xl mx-auto p-4">
      <h1 className="text-2xl sm:text-3xl font-black text-[#D35400] tracking-tight mb-1">IMPORT REFERENCE</h1>
      <p className="text-gray-400 text-sm mb-6">Upload PDFs or photos of techniques, food science articles, or SOPs.</p>
